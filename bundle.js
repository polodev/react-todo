...
var _Todos = __webpack_require__(18);
...
var App = function (_Component) {
  ...
  function App() {
    ...
    _this._toggleTodoCompletion = function (todoId) {
      //mutating way
    ...
    _this._deleteTodo = function (todoId) {
      var todos = _this.state.todos.filter(function (todo) {
        return todo.id !== todoId;
      });
      _this.setState({ todos: todos, isUpdateTodo: false });
    };

    _this._createTodoText = function (event) {
      _this.setState({
        createTodoText: event.target.value
      });
    };

    _this._updateTodoText = function (event) {
      console.log('event');
      _this.setState({
    ...
    _this._updateKeyDown = function (e) {
      if (e.keyCode === 13) {
        return _this._updateTodo(_this.state.updateTodo.id);
      }
    };

    _this._createKeyDown = function (e) {
      if (e.keyCode === 13) {
        return _this._createTodo();
      }
    };

    _this._editTodo = function (todoId) {
      console.log('_edittodo');
      var todo = _this.state.todos.find(function (todo) {
        return todo.id === todoId;
      });
      _this.setState({
        isUpdateTodo: true,
  ...
  _createClass(App, [{
    key: '_updateTodo',
    value: function _updateTodo(todoId) {
      console.log('update todo');
      var _state = this.state,
          todos = _state.todos,
          updateTodoText = _state.updateTodoText;
    ...
    key: '_createTodo',
    value: function _createTodo(todoId) {
      var _state2 = this.state,
          todos = _state2.todos,
          createTodoText = _state2.createTodoText;
      ...
      var newTodos = [].concat(_toConsumableArray(todos), [newTodo]);
    ...
    value: function render() {
      ...
      var _state3 = this.state,
          todos = _state3.todos,
          isUpdateTodo = _state3.isUpdateTodo,
          updateTodoText = _state3.updateTodoText,
          createTodoText = _state3.createTodoText;
      ...
      return _react2.default.createElement(
        ...
        todos.length ? null : _react2.default.createElement(
          'h4',
          { className: 'red' },
        ...
        _react2.default.createElement(
          ...
          todos.map(function (todo) {
            return _react2.default.createElement(GenerateList, {
              _editTodo: _this2._editTodo,
              _deleteTodo: _this2._deleteTodo,
              _toggleTodoCompletion: _this2._toggleTodoCompletion,
              key: todo.id,
              todo: todo });
          })
        ),
        isUpdateTodo ? _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement(
            'h1',
          ...
          _react2.default.createElement('input', { onKeyDown: this._updateKeyDown, onChange: this._updateTodoText, value: updateTodoText, type: 'text' }),
          _react2.default.createElement(
            'button',
            { id: 'update_btn', onClick: function onClick() {
                _this2._updateTodo(_this2.state.updateTodo.id);
              } },
            'update todo'
          )
        ) : null,
        ...
        _react2.default.createElement('input', { onChange: this._createTodoText, onKeyDown: this._createKeyDown, value: createTodoText, type: 'text' }),
        _react2.default.createElement(
          'button',
          { id: 'create_btn', onClick: function onClick() {
              return _this2._createTodo();
            } },
          'create todo'
        )
      );
...
var GenerateList = function GenerateList(props) {
  var todo = props.todo,
      _editTodo = props._editTodo,
      _deleteTodo = props._deleteTodo,
      _toggleTodoCompletion = props._toggleTodoCompletion;

  var span = todo.complete ? _react2.default.createElement(
    'span',
    { onClick: function onClick() {
        return _toggleTodoCompletion(todo.id);
      }, className: 'complete' },
    todo.text
  ) : _react2.default.createElement(
    'span',
...
// module
exports.push([module.i, "body {\n  font-family: 'fira code', Monaco, Menlo, Consolas, Arial;\n  margin: 0;\n  padding: 0;\n}\n.wrapper {\n  width: 80%;\n  margin: 20px auto;\n  background: beige;\n  padding: 15px;\n\n}\nspan {\n  display: inline-block;\n  padding: 5px 10px;\n}\n.red {\n  color: crimson;\n}\nul {\n  list-style: none;\n}\nul li {\n  cursor: pointer;\n}\n.complete {\n  text-decoration: line-through;\n}\ninput {\n  font-family: 'fira code', Monaco, Menlo, Consolas, Arial;\n  padding: 10px;\n  font-size: 16px;\n}\nbutton {\n  border: 1px solid paleturquoise;\n  background: tomato;\n  color: white;\n  font-size: 16px;\n  padding: 5px 10px;\n  cursor: pointer;\n}\nbutton.delete {\n  background: tomato;\n  border: 1px solid skyblue;\n  color: white;\n}\nbutton.edit {\n  border: 1px solid salmon;\n  background: cadetblue;\n  color: white;\n}\nbutton:active, button:focus {\n  outline: none;\n}\nbutton#update_btn {\n  padding: 10px;\n  background: steelblue;\n}\nbutton#create_btn {\n  padding: 10px;\n  background: palevioletred;\n}\nli {\n  margin-bottom: 5px;\n}\n\ninput:focus {\n  outline: none;\n}\n", ""]);
